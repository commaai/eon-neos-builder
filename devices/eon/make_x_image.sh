...
# serial UART is on the USB-C SBU1/SBU2 pins, TTY level 1.8V, 115200, 8n1, no flow control
# TX/RX will flip with USB orientation, be sure to connect ground or output will be noisy
# won't work through comma two uno daughterboard, attempting might damage your TTY device
$TOOLS/mkbootimg \
